                 ...
                 UserDefAlternate **obj, Error **errp)
{
    ...
    default:
        ...
        error_setg(errp, "Invalid parameter type for '%s', expected: UserDefAlternate",
                         name ? name : "null");
                 ...
                 AltEnumBool **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: AltEnumBool",
                         name ? name : "null");
                 ...
                 AltEnumNum **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: AltEnumNum",
                         name ? name : "null");
                 ...
                 AltNumEnum **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: AltNumEnum",
                         name ? name : "null");
                 ...
                 AltEnumInt **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: AltEnumInt",
                         name ? name : "null");
                 ...
                 AltListInt **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: AltListInt",
                         name ? name : "null");
                 ...
                 AltStrObj **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: AltStrObj",
                         name ? name : "null");
                 ...
                 __org_qemu_x_Alt1 **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: __org.qemu_x-Alt1",
                         name ? name : "null");
                 ...
                 __org_qemu_x_Alt **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: __org.qemu_x-Alt",
                         name ? name : "null");
                 ...
                 TestIfAlternate **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: TestIfAlternate",
                         name ? name : "null");
                 ...
                 FeatureAlternate1 **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: FeatureAlternate1",
                         name ? name : "null");
