...
#line 4 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_ioctl " "type 0x%x, arg %p" "\n",
                     ...
                     , type, arg);
#line 124 "trace/trace-accel_kvm.h"
        } else {
#line 4 "../accel/kvm/trace-events"
            qemu_log("kvm_ioctl " "type 0x%x, arg %p" "\n", type, arg);
#line 128 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 5 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_vm_ioctl " "type 0x%x, arg %p" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , type, arg);
#line 155 "trace/trace-accel_kvm.h"
        } else {
#line 5 "../accel/kvm/trace-events"
            qemu_log("kvm_vm_ioctl " "type 0x%x, arg %p" "\n", type, arg);
#line 159 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 6 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_vcpu_ioctl " "cpu_index %d, type 0x%x, arg %p" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , cpu_index, type, arg);
#line 186 "trace/trace-accel_kvm.h"
        } else {
#line 6 "../accel/kvm/trace-events"
            qemu_log("kvm_vcpu_ioctl " "cpu_index %d, type 0x%x, arg %p" "\n", cpu_index, type, arg);
#line 190 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 7 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_run_exit " "cpu_index %d, reason %d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , cpu_index, reason);
#line 217 "trace/trace-accel_kvm.h"
        } else {
#line 7 "../accel/kvm/trace-events"
            qemu_log("kvm_run_exit " "cpu_index %d, reason %d" "\n", cpu_index, reason);
#line 221 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 8 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_device_ioctl " "dev fd %d, type 0x%x, arg %p" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , fd, type, arg);
#line 248 "trace/trace-accel_kvm.h"
        } else {
#line 8 "../accel/kvm/trace-events"
            qemu_log("kvm_device_ioctl " "dev fd %d, type 0x%x, arg %p" "\n", fd, type, arg);
#line 252 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 341 "trace/trace-accel_kvm.h"
        } else {
#line 11 "../accel/kvm/trace-events"
            qemu_log("kvm_init_vcpu " "index: %d id: %lu" "\n", cpu_index, arch_cpu_id);
#line 345 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 372 "trace/trace-accel_kvm.h"
        } else {
#line 12 "../accel/kvm/trace-events"
            qemu_log("kvm_irqchip_commit_routes " "" "\n");
#line 376 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 13 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_irqchip_add_msi_route " "dev %s vector %d virq %d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , name, vector, virq);
#line 403 "trace/trace-accel_kvm.h"
        } else {
#line 13 "../accel/kvm/trace-events"
...
#line 14 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_irqchip_update_msi_route " "Updating MSI route virq=%d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , virq);
#line 434 "trace/trace-accel_kvm.h"
        } else {
#line 14 "../accel/kvm/trace-events"
            qemu_log("kvm_irqchip_update_msi_route " "Updating MSI route virq=%d" "\n", virq);
#line 438 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 15 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_irqchip_release_virq " "virq %d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , virq);
#line 465 "trace/trace-accel_kvm.h"
        } else {
#line 15 "../accel/kvm/trace-events"
...
#line 531 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 558 "trace/trace-accel_kvm.h"
        } else {
#line 18 "../accel/kvm/trace-events"
...
#line 562 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 593 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 20 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_resample_fd_notify " "gsi %d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , gsi);
#line 620 "trace/trace-accel_kvm.h"
        } else {
#line 20 "../accel/kvm/trace-events"
            qemu_log("kvm_resample_fd_notify " "gsi %d" "\n", gsi);
#line 624 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 21 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_dirty_ring_full " "vcpu %d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id);
#line 651 "trace/trace-accel_kvm.h"
        } else {
#line 21 "../accel/kvm/trace-events"
            qemu_log("kvm_dirty_ring_full " "vcpu %d" "\n", id);
#line 655 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 22 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_dirty_ring_reap_vcpu " "vcpu %d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , id);
#line 682 "trace/trace-accel_kvm.h"
        } else {
#line 22 "../accel/kvm/trace-events"
            qemu_log("kvm_dirty_ring_reap_vcpu " "vcpu %d" "\n", id);
#line 686 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 24 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_dirty_ring_reaper " "%s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , s);
#line 744 "trace/trace-accel_kvm.h"
        } else {
#line 24 "../accel/kvm/trace-events"
            qemu_log("kvm_dirty_ring_reaper " "%s" "\n", s);
#line 748 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 25 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_dirty_ring_reap " "reaped %"PRIu64" pages (took %"PRIi64" us)" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , count, t);
#line 775 "trace/trace-accel_kvm.h"
        } else {
#line 25 "../accel/kvm/trace-events"
            qemu_log("kvm_dirty_ring_reap " "reaped %"PRIu64" pages (took %"PRIi64" us)" "\n", count, t);
#line 779 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 26 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_dirty_ring_reaper_kick " "%s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , reason);
#line 806 "trace/trace-accel_kvm.h"
        } else {
#line 26 "../accel/kvm/trace-events"
            qemu_log("kvm_dirty_ring_reaper_kick " "%s" "\n", reason);
#line 810 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 27 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_dirty_ring_flush " "%d" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , finished);
#line 837 "trace/trace-accel_kvm.h"
        } else {
#line 27 "../accel/kvm/trace-events"
            qemu_log("kvm_dirty_ring_flush " "%d" "\n", finished);
#line 841 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 868 "trace/trace-accel_kvm.h"
        } else {
#line 28 "../accel/kvm/trace-events"
            qemu_log("kvm_destroy_vcpu " "" "\n");
#line 872 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 899 "trace/trace-accel_kvm.h"
        } else {
#line 29 "../accel/kvm/trace-events"
            qemu_log("kvm_failed_get_vcpu_mmap_size " "" "\n");
#line 903 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 930 "trace/trace-accel_kvm.h"
        } else {
#line 30 "../accel/kvm/trace-events"
            qemu_log("kvm_cpu_exec " "" "\n");
#line 934 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 961 "trace/trace-accel_kvm.h"
        } else {
#line 31 "../accel/kvm/trace-events"
            qemu_log("kvm_interrupt_exit_request " "" "\n");
#line 965 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 992 "trace/trace-accel_kvm.h"
        } else {
#line 32 "../accel/kvm/trace-events"
            qemu_log("kvm_io_window_exit " "" "\n");
#line 996 "trace/trace-accel_kvm.h"
        }
    }
}
...
#line 34 "../accel/kvm/trace-events"
            qemu_log("%d@%zu.%06zu:kvm_convert_memory " "start 0x%" PRIx64 " size 0x%" PRIx64 " %s" "\n",
                     ...
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , start, size, msg);
#line 1054 "trace/trace-accel_kvm.h"
        } else {
#line 34 "../accel/kvm/trace-events"
            qemu_log("kvm_convert_memory " "start 0x%" PRIx64 " size 0x%" PRIx64 " %s" "\n", start, size, msg);
#line 1058 "trace/trace-accel_kvm.h"
        }
    }
}
