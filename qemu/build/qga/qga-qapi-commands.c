...
static void qmp_marshal_output_GuestDiskStatsInfoList(GuestDiskStatsInfoList *ret_in,
                                QObject **ret_out, Error **errp)
{
    Visitor *v;

    v = qobject_output_visitor_new_qmp(ret_out);
    if (visit_type_GuestDiskStatsInfoList(v, "unused", &ret_in, errp)) {
        visit_complete(v, ret_out);
    }
    visit_free(v);
    v = qapi_dealloc_visitor_new();
    visit_type_GuestDiskStatsInfoList(v, "unused", &ret_in, NULL);
    visit_free(v);
}
...
void qmp_marshal_guest_get_diskstats(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_marshal_output_GuestDiskStatsInfoList(retval, ret, errp);
...
static void qmp_marshal_output_GuestCpuStatsList(GuestCpuStatsList *ret_in,
                                QObject **ret_out, Error **errp)
{
    Visitor *v;

    v = qobject_output_visitor_new_qmp(ret_out);
    if (visit_type_GuestCpuStatsList(v, "unused", &ret_in, errp)) {
        visit_complete(v, ret_out);
    }
    visit_free(v);
    v = qapi_dealloc_visitor_new();
    visit_type_GuestCpuStatsList(v, "unused", &ret_in, NULL);
    visit_free(v);
}
...
void qmp_marshal_guest_get_cpustats(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_marshal_output_GuestCpuStatsList(retval, ret, errp);
